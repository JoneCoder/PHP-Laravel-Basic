...
<!-- Navigation
    ==========================================-->
<nav id="menu" class="navbar navbar-default navbar-fixed-top" style="margin-top: 60px;">
    <div class="container">
        <!-- Brand and toggle get grouped for better mobile display -->
        <div class="navbar-header">
            <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1"> <span class="sr-only">Toggle navigation</span> <span class="icon-bar"></span> <span class="icon-bar"></span> <span class="icon-bar"></span> </button>
            <a class="navbar-brand page-scroll" href="logo_edit.php?myadmin=<?php echo $afterAssoc['username']; ?>">Innova</a>
    ...
    <div class="container">
        <div class="col-md-8">
            <div class="row">
                ...
                <form action="validate/message_post.php" method="post" id="contactForm" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <p class="help-block text-danger">
                            ...
                            elseif (!empty($_GET['messageWordErr'])){
                                echo 'Message must be 100 words include';
                            }
                            ?>
                        </p>
                    </div>
