...
if($_SESSION['login'] == 'Admin!'){
    ...
    $_SESSION['adminBack'] = $adminName;

    require 'database/database.php';
    $admin_profile = "SELECT * FROM `admin` WHERE username='$adminName' ";
    $profile_data = mysqli_query($databaseConnect, $admin_profile);
    $after_assoc = mysqli_fetch_assoc($profile_data);

    $admin = $after_assoc['username'];
    $admin_pic = $after_assoc['profile_pic'];
...
<div class="container">
    <div class="row">
        <div class="col-md-10 m-auto bg-success">
            <div class="row">
                <div class="col-9 text-left p-2 text-white">
                    <div class="image float-left">
                        <img src="uploads/<?php echo $admin_pic; ?>" alt="profile.jpg"/>
                    </div>
                    <h3 class="pt-2"><?php echo $admin; ?></h3>
                </div>
            ...
            <table class="table">
                ...
                foreach ($user_data as $data) {
                    ...
                    <tr class="table-primary">
                        ...
                        <td>
                            <img src="uploads/<?php echo $data['profile_pic']; ?>" alt="profile.jpg" class="image">
                        </td>
                        <td>
