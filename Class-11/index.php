        ...
        <div class="col-md-8 ml-auto mr-auto mt-5 bg-light form-module">
            ...
            <div class="row">
                <div class="col-md-12 text-primary">
                    <form action="validate/form_validate.php" method="post" enctype="multipart/form-data">
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-11 m-auto text-danger text-center">
                                <span>
                                    <?php
                                    if(!empty($_GET['imageErr'])){
                                        if ($_GET['imageErr'] == 1){
                                            echo "Please fill out of this filed.";
                                        }
                                        elseif ($_GET['imageErr'] == 2){
                                            echo "Invalid file format!";
                                        }
                                        elseif ($_GET['imageErr'] == 3){
                                            echo "Your file size too large!";
                                        }
                                    }
                                    ?>
                                </span>
